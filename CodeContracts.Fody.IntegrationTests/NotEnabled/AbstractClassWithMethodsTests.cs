...
namespace CodeContracts.Fody.IntegrationTests.NotEnabled
{
    public class AbstractClassWithMethodsTests
    {
        ...
        public void MethodWithNullParameterTest()
        {
            ...
            ContractAssert.With<AbstractClassWithMethodsImplementation>()
                .Success(sut => sut.MethodWithNullParameter(""));
        }
        ...
        public void MethodWithNullAndNotNullParametersTest()
        {
            ...
            ContractAssert.With<AbstractClassWithMethodsImplementation>()
                .Success(sut => sut.MethodWithNullAndNotNullParameters(null, null));

            ContractAssert.With<AbstractClassWithMethodsImplementation>()
                .Success(sut => sut.MethodWithNullAndNotNullParameters("", ""));
        }
        ...
        public void MethodAbstractWithNullParameterTest()
        {
            ...
            ContractAssert.With<AbstractClassWithMethodsImplementation>()
                .Success(sut => sut.MethodAbstractWithNullParameter(""));
        }
        ...
        public void MethodAbstractWithNullAndNotNullParametersTest()
        {
            ...
            ContractAssert.With<AbstractClassWithMethodsImplementation>()
                .Success(sut => sut.MethodAbstractWithNullAndNotNullParameters(null, null));

            ContractAssert.With<AbstractClassWithMethodsImplementation>()
                .Success(sut => sut.MethodAbstractWithNullAndNotNullParameters("", ""));
        }
    }
}
