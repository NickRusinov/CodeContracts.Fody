...
namespace CodeContracts.Fody.IntegrationTests.WithExceptions
{
    public class AbstractClassWithPropertiesTests
    {
        ...
        public void PropertyWithNegativeTest()
        {
            ...
            ContractAssert.With<AbstractClassWithPropertiesImplementation>()
                .Fail<ArgumentOutOfRangeException>(sut => sut.PropertyWithNegative = 55);
        }
        ...
        public void PropertyWithEquals1000GetOnlyTest()
        {
            ...
            ContractAssert.With<AbstractClassWithPropertiesImplementation>()
                ...
                .Fail(sut => sut.PropertyWithEquals1000GetOnly.Get());
        }
        ...
        public void PropertyWithNotZeroSetOnlyTest()
        {
            ...
            ContractAssert.With<AbstractClassWithPropertiesImplementation>()
                .Fail<ArgumentOutOfRangeException>(sut => sut.PropertyWithNotZeroSetOnly = 0);
        }
        ...
        public void PropertyAbstractWithPositiveTest()
        {
            ...
            ContractAssert.With<AbstractClassWithPropertiesImplementation>()
                .Fail<ArgumentOutOfRangeException>(sut => sut.PropertyAbstractWithPositive = - 55);
        }
        ...
        public void PropertyAbstractWithEquals1000GetOnlyTest()
        {
            ...
            ContractAssert.With<AbstractClassWithPropertiesImplementation>()
                ...
                .Fail(sut => sut.PropertyAbstractWithEquals1000GetOnly.Get());
        }
        ...
        public void PropertyAbstractWithNotZeroSetOnlyTest()
        {
            ...
            ContractAssert.With<AbstractClassWithPropertiesImplementation>()
                .Fail<ArgumentOutOfRangeException>(sut => sut.PropertyAbstractWithNotZeroSetOnly = 0);
        }
    }
}
